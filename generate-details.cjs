        ...
        <div class="ind-hero-grid">
          ...
          <div class="ind-hero-right">
            ...
            <div class="stacked-card">
              ...
              <a href="/services/gst-returns.html" class="explore-link">Explore more <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stacked-card">
              ...
              <a href="/services/accounting-advisory.html" class="explore-link">Explore more <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stacked-card">
