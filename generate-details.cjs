  ...
  <section class="section" style="background-color: #fafaf9; padding: 80px 0; border-top: 1px solid var(--color-ivory-dark);">
    <div class="container">
      <div class="section-header" style="text-align: center; margin-bottom: 50px;">
        <h2 style="font-family: var(--font-serif); font-size: 2.5rem; font-weight: 700; color: var(--color-slate-dark); margin-bottom: 15px; text-transform: none;">Pan-Canada Corporate Tax Filing Coverage</h2>
